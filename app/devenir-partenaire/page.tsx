    ...
    <div className="page-wrap bg-bg-body">
      ...
      <div className="relative w-full min-h-[35vh] flex items-end pb-12 pt-32 mt-[-5.5rem] bg-bg-alt overflow-hidden border-b border-border">
        ...
        <div className="container relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-primary-dk mb-6 max-w-4xl" style={{ fontFamily: "var(--font-display)" }}>
            Développez votre activité avec <span className="text-primary italic">Nova Intervention</span>
          </h1>
          <p className="text-lg md:text-xl text-text-muted max-w-2xl leading-relaxed">
            Rejoignez l'élite des artisans français. Accédez à un flux constant de missions qualifiées par IA dans votre zone.
          </p>
        </div>
      </div>
      ...
      <main className="container py-16">
        ...
        <section className="mb-24">
          <div className="bg-primary-dk rounded-[2.5rem] p-8 md:p-14 text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-extrabold mb-6" style={{ fontFamily: "var(--font-display)" }}>
                  Simulez vos revenus mensuels
                </h2>
                <p className="text-white/70 text-lg mb-10 leading-relaxed">
                  Ajustez vos paramètres pour estimer votre chiffre d'affaires net après commission <span className="text-white font-bold">Nova</span>.
                </p>
                ...
                <div className="space-y-10">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-3xl font-black text-white">{missionsPerWeek}</span>
                    </div>
                    <input
                      type="range"
                      min="1"
                      ...
                      onChange={(e) => setMissionsPerWeek(parseInt(e.target.value))}
              ...
              <div className="bg-white/5 border border-white/10 rounded-[2rem] p-10 flex flex-col items-center justify-center text-center backdrop-blur-sm shadow-[0_20px_50px_rgba(0,0,0,0.2)]">
                <p className="text-white/60 font-bold uppercase tracking-widest text-sm mb-4">Estimation de vos revenus nets</p>
                <div className="flex items-baseline gap-2 mb-2">
                  <span className="text-6xl md:text-7xl font-black text-white" style={{ fontFamily: "var(--font-display)" }}>
                    {monthlyEarnings.toLocaleString()}
                  </span>
                  <span className="text-3xl font-bold text-white/80">€</span>
                </div>
                <p className="text-white/40 font-medium">Par mois (Net après commission)</p>
                
                <div className="w-full h-px bg-white/10 my-8"></div>
                
                <div className="grid grid-cols-2 w-full gap-4">
                  <div className="text-left">
                    <p className="text-white/50 text-xs font-bold uppercase mb-1">Marge Nova</p>
                    <p className="text-white text-lg font-bold">20%</p>
                  </div>
                  <div className="text-right">
                    <p className="text-white/50 text-xs font-bold uppercase mb-1">Paiements</p>
                    <p className="text-white text-lg font-bold text-green-400">J+1</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7">
            <h2 className="text-3xl font-extrabold text-primary-dk mb-10" style={{ fontFamily: "var(--font-display)" }}>
              Pourquoi travailler avec Nova ?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {benefits.map((b) => (
                <div key={b.title} className="card group bg-white border border-border hover:border-primary/30 hover:shadow-xl transition-all duration-300">
                  ...
                  <h3 className="font-bold text-primary-dk text-xl mb-3">{b.title}</h3>
          ...
          <div className="lg:col-span-5 sticky top-8">
            <div className="card-xl bg-white border border-border shadow-2xl overflow-hidden">
              <div className="bg-bg-alt px-8 py-6 border-b border-border">
                <h2 className="text-2xl font-bold text-primary-dk mb-1">Postulez maintenant</h2>
              ...
              <form onSubmit={handleSubmit} className="p-8 flex flex-col gap-5">
                ...
                <div>
                  <label className="block text-sm font-bold text-primary-dk mb-1.5">Téléphone Professionnel</label>
                  <input 
                    type="tel" 
                    required
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-bold text-primary-dk mb-1.5">Ville</label>
                    <input 
                      type="text" 
                      required
                      value={formData.city}
                  ...
                  <div>
                    <label className="block text-sm font-bold text-primary-dk mb-1.5">Métier</label>
                    <select 
                      required
                ...
                <div>
                  <label className="block text-sm font-bold text-primary-dk mb-1.5">Numéro SIRET</label>
                  <input 
                    type="text" 
                    required
                ...
                <div className="mt-4">
                  <button type="submit" className="btn btn-primary w-full justify-center py-4 text-lg shadow-lg shadow-primary/20">
